...
function DataCorrection(props) {
    ...
    const ChangeDatacrctionRedioHandler = (event) => {
        ...
        else if (event.target.value === "DuplicateAddresh") {
            setProduct([])
            setShowWgt(false)
            setShowItmVlu(false)
            setShowPkgList(true)
    ...
    const ChangeitemValueHandler = (event) => {
        console.log("id & pkgkitem - "+JSON.stringify(event.target.value));
        console.log("index name- "+JSON.stringify(event.target.name));
        //add logic 
        var Temp_tblPkglist = product;
        var index = event.target.name;
    ...
    const ChangebannedItemHandler = (event) => {
        console.log("id & pkgkitem - "+JSON.stringify(event.target.value));
        console.log("index name- "+JSON.stringify(event.target.name));
        //add logic 
        var Temp_tblPkglist = tblPkglist;
    ...
    let dataRadio = ["Wight", "ItemValue", "PkgList","DuplicateAddresh","NoKyc", "BannedItem"];
    return (
        <div>
            <div>
                <Sidebar />
                                        ...
                                        product.map(
                                            (ItemValue,i) => (
                                                <TableRow hover key={ItemValue.itemId}>
                                                    ...
                                                    <TableCell >
                                                        <input size="sm" name={i} value={ItemValue.itemValue} onChange={ChangeitemValueHandler} />
                                                </TableCell>
                                                    <TableCell>
                                                    <input size="sm" name={i} value={ItemValue.bannedItem} onChange={ChangebannedItemHandler}  />
                                                    </TableCell>
                                                </TableRow>
                                            ))}
                                </TableBody>
